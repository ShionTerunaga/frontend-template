...
const content = `${caution}NUXT_PUBLIC_API_KEY="https://hp-api.onrender.com/api/characters"\n`;

export const nuxtEnv: Array<Target> = [
    {
        alias: "vn-sc",
        dir: path.join(appsDir, "vue", "nuxt", "scoped-css"),
        content
    },
    {
        alias: "vn-ve",
        dir: path.join(appsDir, "vue", "nuxt", "vanilla-extract"),
        content
    }
];
